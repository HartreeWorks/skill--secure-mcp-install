...
A Claude Code skill for securely installing MCP servers from third-party sources with automated security scanning and commit pinning.
...
```bash
npx skills add HartreeWorks/skill--secure-mcp-install
```
